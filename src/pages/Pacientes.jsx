...
import { Plus, Trash2, Eye, CheckCircle, RefreshCw } from "lucide-react";
...
export default function Pacientes({ selectedSede, sedeId }) {
    ...
    async function handleCreate(e) {
        ...
        try {
            await createPacienteEstudio(form);
    ...
    async function handleDelete(id) {
        ...
        try {
            await deletePacienteEstudio(id);
            await loadData(sedeId);
        } catch (error) {
        ...
        <section className="page">
            <div className="page-header">
                <div>
                    ...
                    <p>
                        Gestión de órdenes, muestras, estudios y emisión de resultados.
            ...
            <div className="filters-bar">
                <input
                    placeholder="Buscar por paciente, DNI, estudio, sede u obra social..."
                    value={search}
            ...
            <div className="table-card">
                <table>
                    ...
                    <tbody>
                        {loading && (
                            <tr>
                                <td colSpan="9">Cargando pacientes y estudios...</td>
                            </tr>
                        )}
